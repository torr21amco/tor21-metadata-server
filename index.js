...
app.get('/metadata/:tokenId', async (req, res) => {
  try {
    ...
    const dominio = await contract.methods.dominioPorNFT(tokenId).call();
    const nivel = await contract.methods.nivelProteccion(tokenId).call();
    const expiracion = await contract.methods.expiracionNFT(tokenId).call();
    const activo = await contract.methods.dominioActivo(tokenId).call();
    ...
    const metadata = {
      ...
      attributes: [
        { trait_type: "Nivel de Protección", value: nivel.toString() },
        { trait_type: "Dominio", value: dominio },
